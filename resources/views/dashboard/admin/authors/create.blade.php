...
<x-dashboard.index>
    ...
    <div class="row justify-content-center">
        <div class="card col-md-10">
            <div class="card-title text-center mt-3">إضافة مؤلف جديد</div>
            <div class="card-body">
                <form action="{{ route('admin.authors.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea type="text" required id="userDescription" name="userDescription" class="form-control @error('userDescription') is-invalid @enderror" value="{{ old('userDescription')}}" >{{old('userDescription')}}</textarea>
