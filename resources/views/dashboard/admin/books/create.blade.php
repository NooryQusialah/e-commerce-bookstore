...
<x-dashboard.index>
    ...
    <div class="row justify-content-center">
        <div class="card col-md-10">
            <div class="card-title text-center mt-3">إضافة كتاب جديد</div>
                ...
                <form action="{{ route('admin.books.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}">
                            @error('title') <span class="invalid-feedback"><strong>{{ $message }}</strong></span> @enderror
                        </div>

                        <div class="form-group col-md-6">
                            <label for="isBn">الرقم التسلسلي</label>
                            <input type="text" required id="isBn" name="isBn" class="form-control @error('isBn') is-invalid @enderror" value="{{ old('isBn') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" required id="cover_image" name="cover_image" class="form-control @error('cover_image') is-invalid @enderror" value="{{ old('cover_image') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="authors" name="authors[]" class="form-control @error('authors') is-invalid @enderror" multiple>
                                <option disabled selected>اختر المؤلفون</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="publisher" name="publisher" class="form-control @error('publisher') is-invalid @enderror">
                                ...
                                @foreach($publishers as $publisher)
                                    <option value="{{ $publisher->id }}">{{ $publisher->user->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea type="text" required id="description" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" ></textarea>
                            @error('description') <span class="invalid-feedback"><strong>{{ $message }}</strong></span> @enderror
                        </div>

                        <div class="form-group col-md-6">
                            <label for="price">سعر الكتاب</label>
                            <input type="text" required id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required id="publish_year" name="publish_year" class="form-control @error('publish_year') is-invalid @enderror" value="{{ old('publish_year') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required id="numberOfPages" name="numberOfPages" class="form-control @error('numberOfPages') is-invalid @enderror" value="{{ old('numberOfPages') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required id="numberOfCopies" name="numberOfCopies" class="form-control @error('numberOfCopies') is-invalid @enderror" value="{{ old('numberOfCopies') }}">
